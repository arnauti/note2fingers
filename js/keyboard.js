...
MidiManager.notes[89] = {note: 89, pos: 77, name: "F6"};
MidiManager.notes[88] = {note: 88, pos: 76, name: "E6"};
MidiManager.notes[87] = {note: 87, pos: 75, name: "D#6/Eb6"};
MidiManager.notes[86] = {note: 86, pos: 75, name: "D6"};
MidiManager.notes[85] = {note: 85, pos: 74, name: "C#6/Db6"};
MidiManager.notes[84] = {note: 84, pos: 74, name: "C6"};
MidiManager.notes[83] = {note: 83, pos: 73, name: "B5"};
MidiManager.notes[82] = {note: 82, pos: 72, name: "A#5/Bb5"};
MidiManager.notes[81] = {note: 81, pos: 72, name: "A5"};
MidiManager.notes[80] = {note: 80, pos: 71, name: "G#5/Ab5"};
MidiManager.notes[79] = {note: 79, pos: 71, name: "G5"};
MidiManager.notes[78] = {note: 78, pos: 70, name: "F#5/Gb5"};
MidiManager.notes[77] = {note: 77, pos: 70, name: "F5"};
MidiManager.notes[76] = {note: 76, pos: 69, name: "E5"};
MidiManager.notes[75] = {note: 75, pos: 68, name: "D#5/Eb5"};
MidiManager.notes[74] = {note: 74, pos: 68, name: "D5"};
MidiManager.notes[73] = {note: 73, pos: 67, name: "C#5/Db5"};
MidiManager.notes[72] = {note: 72, pos: 67, name: "C5"};
MidiManager.notes[71] = {note: 71, pos: 66, name: "B4"};
MidiManager.notes[70] = {note: 70, pos: 65, name: "A#4/Bb4"};
MidiManager.notes[69] = {note: 69, pos: 65, name: "A4"};
MidiManager.notes[68] = {note: 68, pos: 64, name: "G#4/Ab4"};
MidiManager.notes[67] = {note: 67, pos: 64, name: "G4"};
MidiManager.notes[66] = {note: 66, pos: 63, name: "F#4/Gb4"};
MidiManager.notes[65] = {note: 65, pos: 63, name: "F4"};
MidiManager.notes[64] = {note: 64, pos: 62, name: "E4"};
MidiManager.notes[63] = {note: 63, pos: 61, name: "D#4/Eb4"};
MidiManager.notes[62] = {note: 62, pos: 61, name: "D4"};
MidiManager.notes[61] = {note: 61, pos: 60, name: "C#4/Db4"};
MidiManager.notes[60] = {note: 60, pos: 60, name: "C4"};
MidiManager.notes[59] = {note: 59, pos: 59, name: "B3"};
MidiManager.notes[58] = {note: 58, pos: 58, name: "A#3/Bb3"};
MidiManager.notes[57] = {note: 57, pos: 58, name: "A3"};
MidiManager.notes[56] = {note: 56, pos: 57, name: "G#3/Ab3"};
MidiManager.notes[55] = {note: 55, pos: 57, name: "G3"};
MidiManager.notes[54] = {note: 54, pos: 56, name: "F#3/Gb3"};
MidiManager.notes[53] = {note: 53, pos: 56, name: "F3"};
MidiManager.notes[52] = {note: 52, pos: 55, name: "E3"};
MidiManager.notes[51] = {note: 51, pos: 54, name: "D#3/Eb3"};
MidiManager.notes[50] = {note: 50, pos: 54, name: "D3"};
MidiManager.notes[49] = {note: 49, pos: 53, name: "C#3/Db3"};
MidiManager.notes[48] = {note: 48, pos: 53, name: "C3"};
